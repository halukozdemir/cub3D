...
SRCS = main.c src/parser/fill_struct.c src/parser/init.c src/utils/parser_utils.c src/utils/parser_utils2.c src/checker/map_checker.c src/checker/image_checker.c src/cleanup/clean_up.c src/checker/map_checker_2.c $(LIBFT_SRCS) src/executor/mlx.c src/parser/player.c src/checker/image_checker_2.c
OBJS = $(SRCS:.c=.o)
